-- Open source bootstrap for hm-dianping AI edition.
-- Usage: import this file into an empty MySQL instance.
...
-- ----------------------------
-- AI Upgrade 2026-03-26: tb_shop 商铺简介 + 风控相关
-- ----------------------------
ALTER TABLE `tb_shop`
...
(9003, '19990000003', '', 'ai_seed_user_03', '', NOW(), NOW()),
(9004, '19990000004', '', 'ai_seed_user_04', '', NOW(), NOW()),
...
CREATE TEMPORARY TABLE `tmp_ai_food_shop_seed` (
  `seq` int NOT NULL,
  ...
  `hint_a` varchar(255) NOT NULL,
  `hint_b` varchar(255) NOT NULL,
  `hint_c` varchar(255) NOT NULL,
  `scene` varchar(64) NOT NULL,
  PRIMARY KEY (`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `tmp_ai_food_shop_seed` (`seq`, `name`, `area`, `address`, `x`, `y`, `avg_price`, `sold`, `comments`, `score`, `open_hours`, `shop_desc`, `hint_a`, `hint_b`, `hint_c`, `scene`) VALUES
(1, '运河轻养粥铺', '运河上街', '台州路32号', 120.149120, 30.333810, 32, 1860, 760, 47, '06:30-21:30', '主打现熬白粥、南瓜粥和清汤小菜；支持少油少盐、素配菜和热水续杯；门店有空调与短时休息座位，适合肠胃不适、没胃口时来吃。', '白粥和菌菇汤底比较养胃', '支持少油少盐和素配菜', '店里能续热水，坐一会也舒服', '清淡养胃'),
(2, '拱宸桥酸汤小馆', '拱宸桥/上塘', '金华路118号', 120.151220, 30.334650, 58, 2680, 1120, 46, '10:30-22:00', '主打酸汤肥牛、番茄酸汤和酸口开胃菜；可做少辣版本，也有蔬菜和菌菇搭配；适合想吃酸口、又不想太油的人。', '酸汤开胃但不会特别冲', '可以做少辣版本，口味更柔和', '菌菇和蔬菜配菜比较全', '酸口开胃'),
(3, '上塘果语鲜切', '拱宸桥/上塘', '上塘路268号', 120.147850, 30.332940, 26, 1320, 540, 45, '09:00-22:30', '主营鲜切水果、果切杯、果汁和瓶装水；适合路过补给、买水、带走轻食；门口有短暂停留区。', '水果很新鲜，切盒选择多', '买瓶水和果汁都很方便', '适合饭前没胃口时先补点清爽的', '水果补给'),
(4, '乐堤港慢茶小馆', '远洋乐堤港', '丽水路66号B1-17', 120.146520, 30.331880, 42, 2150, 960, 48, '10:00-22:30', '主打热茶、奶茶、桂花乌龙和轻甜点；店里座位安静、空调稳定，适合休息、聊天和等人；也能提供热水。', '热茶选择多，口味不甜腻', '座位区安静，适合坐着休息', '能补热水，聊天办公都不尴尬', '喝茶休息'),
(5, '水晶城炭火小串', '水晶城', '上塘路455号负一层', 120.153980, 30.336420, 68, 3590, 1450, 46, '17:00-02:00', '主打平价烧烤、小串和夜宵拼盘；人均不高，适合朋友聚餐；晚上营业时间长，适合想吃烧烤但预算有限的用户。', '小串种类多，点单灵活', '人均不高，几个人分着吃比较划算', '晚间营业时间长，适合夜宵场景', '平价烧烤'),
(6, '运河巷子烤肉饭', '运河上街', '台州路88号', 120.154820, 30.338110, 39, 2410, 980, 45, '10:30-21:30', '主营现烤鸡腿饭、烤肉饭和热饮；套餐价格友好，上餐快；适合一个人简单吃顿热乎的。', '烤肉饭分量实在，上餐也快', '套餐价格比较友好，工作日午餐压力不大', '一个人来吃也不会有负担', '平价烤肉饭'),
(7, '大关素味食堂', '大关', '香积寺东路112号', 120.145970, 30.337220, 36, 1880, 720, 47, '10:00-20:30', '主打素菜套餐、菌菇汤和杂粮饭；少油少盐，适合吃素、控油和肠胃不舒服的人；店内环境整洁。', '素菜组合丰富，不会只剩青菜', '少油少盐，吃完不会有负担', '菌菇汤和杂粮饭很适合清淡需求', '素食轻负担'),
(8, '河畔番茄砂锅面', '大关', '湖州街77号', 120.148780, 30.329950, 34, 2240, 930, 46, '09:30-21:00', '主打番茄汤底砂锅面、鸡蛋面和蔬菜面；汤底偏清爽，支持加青菜和少油；适合没胃口时来一碗热汤面。', '番茄汤底偏清爽，酸度柔和', '可以加很多青菜，少油也能做', '热汤面下肚会比较舒服', '番茄热汤'),
(9, '拱苑路轻食工坊', '拱宸桥/上塘', '拱苑路18号', 120.152630, 30.327880, 45, 1670, 680, 47, '09:00-21:00', '主打沙拉碗、鸡胸轻食和素食碗；酱料可分开装，适合健身、控卡和想吃清淡的人；支持外带。', '沙拉和轻食碗搭配比较自由', '酱料能分开，清淡需求更好控制', '素食碗和鸡胸碗都比较适合控卡', '轻食控卡'),
(10, '台州路港式茶餐厅', '运河上街', '台州路58号', 120.144910, 30.330660, 56, 2860, 1230, 46, '10:00-22:00', '主营港式奶茶、菠萝包、清汤车仔面和简餐；既能吃正餐也能喝点东西坐一会；适合朋友小聚或工作日晚饭。', '港式奶茶和热饮选择比较全', '既能吃面也能配小点心，组合很灵活', '店里有座位，休息聊天比较方便', '茶餐厅补给'),
(11, '运河老友酸菜鱼', '运河上街', '金华路200号', 120.150560, 30.325540, 82, 3120, 1360, 47, '11:00-22:00', '主打酸菜鱼、番茄鱼和酸口热菜；鱼片分量足，也能点蔬菜拼盘；适合喜欢酸口、多人聚餐的人群。', '酸菜鱼偏开胃，酸味比较明显', '番茄鱼对不太能吃辣的人更友好', '多人一起点菜会更划算', '酸口鱼锅'),
(12, '乐堤港汤煲馆', '远洋乐堤港', '丽水路58号1层', 120.157210, 30.332410, 64, 2190, 970, 48, '10:30-21:30', '主打老鸭汤、菌菇汤、番茄牛腩汤和家常煲；热汤类选择多，适合感冒、没胃口、想吃暖一点的人；支持打包。', '热汤种类多，天冷或者感冒时很合适', '菌菇汤和番茄汤底都比较顺口', '想打包带走也比较方便', '热汤暖胃'),
(13, '北城果木烤鱼', '北部新城', '杭行路666号4层', 120.140850, 30.339220, 89, 2520, 1180, 46, '11:00-23:00', '主营果木烤鱼、青花椒烤鱼和蒜香烤鱼；支持少辣与酸辣两种口味走向；适合爱吃鱼和多人聚餐场景。', '烤鱼口味可调，少辣和酸辣都能选', '蒜香烤鱼更适合不想吃太辣的人', '几个人一起吃会比单点更合适', '烤鱼聚餐'),
(14, '拱宸桥夜猫烧鸟', '拱宸桥/上塘', '上塘路1018号', 120.156840, 30.340510, 73, 2780, 1210, 45, '17:30-01:30', '主打烧鸟、烤串和夜宵小食；适合朋友聚会和晚间加餐；口味偏香口，喜欢烧烤的人会比较容易复购。', '烧鸟和烤串的夜宵氛围比较到位', '适合晚间加餐或者朋友聚会', '香口路线明显，爱吃烧烤的人会喜欢', '夜宵烧鸟'),
(15, '水晶城白粥小炒', '水晶城', '上塘路462号', 120.147260, 30.341120, 44, 1730, 710, 46, '09:00-21:30', '主打白粥、青菜小炒和蒸蛋；支持少油清淡做法，适合老人、小孩和肠胃不舒服的人；出餐节奏稳定。', '白粥和蒸蛋都比较顺胃', '小炒能做清淡版本，不会太油', '适合带家人或者没胃口时来吃', '白粥清淡'),
(16, '上塘茶寮', '拱宸桥/上塘', '上塘路688号', 120.149680, 30.345180, 38, 1620, 620, 47, '10:00-22:00', '主打热茶、花草茶和轻点心；门店有较安静的座位区，适合临时休息、等人、聊天；也有瓶装水和热饮。', '热茶和花草茶种类比较全', '座位区相对安静，适合短时休息', '想买水、等人或者坐一会都方便', '休息喝茶'),
(17, '金华路补给简餐站', '大关', '金华路216号', 120.143560, 30.335880, 22, 1460, 590, 45, '07:30-22:30', '主营瓶装水、三明治、热狗和简易热饮；适合赶路补给、买水、简单垫肚子；门口取餐快。', '买瓶装水和热饮都很快', '三明治和简餐适合赶时间时垫一下', '如果只是想补给，不需要坐太久', '买水补给'),
(18, '运河轻煮面馆', '运河上街', '台州路126号', 120.151940, 30.342660, 31, 2380, 880, 46, '08:30-21:00', '主打清汤面、青菜面和番茄鸡蛋面；汤头不重，支持加青菜和少油；适合清淡饮食、感冒和没胃口时吃点热乎的。', '清汤面口味轻，不会太刺激', '青菜和番茄鸡蛋面的选择都比较稳', '感冒或者没胃口时吃一碗热面很合适', '清汤面馆'),
(19, '大关菌菇煲', '大关', '湖州街166号', 120.155260, 30.329440, 59, 1940, 820, 47, '10:30-21:30', '主营菌菇煲、豆腐煲和蔬菜拼盘；偏清润路线，也有素食友好搭配；适合想吃热菜又不想太重口的人。', '菌菇煲和豆腐煲都比较清润', '蔬菜拼盘分量足，素食友好', '想吃热菜但不想太重口时比较合适', '菌菇暖胃'),
(20, '乐堤港牛肉火锅', '远洋乐堤港', '丽水路58号4层', 120.158820, 30.337880, 118, 3460, 1520, 47, '11:00-23:00', '主打牛肉火锅、肥牛拼盘和重口锅底；适合多人聚餐和想吃肉的人群；整体更偏重口和高热量。', '牛肉和肥牛拼盘是核心卖点', '更适合多人聚餐和想吃肉的时候', '整体偏重口，不属于清淡路线', '牛肉火锅'),
(21, '水晶城韩式烤肉', '水晶城', '上塘路458号5层', 120.160120, 30.333240, 128, 3280, 1490, 46, '11:00-23:30', '主营韩式烤肉、五花肉和部队锅；整体偏香辣和肉食路线；适合聚会、庆祝和重口味需求。', '烤肉和部队锅都偏肉食路线', '适合聚会庆祝，不太适合想吃清淡的时候', '喜欢重口和烤肉的人会更容易满足', '韩式烤肉'),
(22, '上塘川味冒菜', '拱宸桥/上塘', '上塘路926号', 120.154360, 30.344220, 46, 2870, 1280, 45, '10:30-22:30', '主打川味冒菜、麻辣拌和重口热菜；辣度可调，但整体仍偏刺激；适合爱吃辣、想吃重口味的人。', '麻辣味型比较鲜明，吃起来很过瘾', '虽然能调辣度，但整体还是偏刺激', '如果最近肠胃一般，不建议优先选它', '川味冒菜'),
(23, '台州路家常杭帮菜', '运河上街', '台州路96号', 120.146340, 30.326880, 66, 2390, 1010, 47, '10:30-21:30', '主打家常杭帮菜、清蒸和时令热菜；适合家庭聚餐，也有清淡菜品可选；整体口味比重油重辣店更稳。', '清蒸和家常菜选择比较多', '家庭聚餐和照顾不同口味都比较方便', '如果想吃正餐但又不想太刺激，这家比较稳', '家常清淡'),
(24, '拱宸桥早餐豆浆铺', '拱宸桥/上塘', '金华路77号', 120.142740, 30.328420, 18, 2640, 980, 46, '06:00-13:30', '主营豆浆、油条、白粥、包子和鸡蛋；人均低，适合早饭、赶时间和肠胃轻负担需求；热豆浆供应稳定。', '豆浆和白粥都比较适合早上暖胃', '人均很低，预算友好', '赶时间或者只想吃点热乎的都方便', '平价早餐'),
(25, '运河果茶补给站', '运河上街', '台州路142号', 120.149940, 30.339560, 24, 1980, 810, 45, '09:30-22:00', '主营果茶、柠檬水、瓶装水和少糖饮品；适合散步路上补给、买水和短暂停留；门口取餐快。', '果茶和柠檬水走清爽路线', '买瓶水和少糖饮品都很方便', '路过补给或者短暂停留都很合适', '果茶补水'),
(26, '乐堤港甜汤铺', '远洋乐堤港', '丽水路58号B1-09', 120.147520, 30.346220, 28, 1710, 690, 46, '10:00-22:00', '主打银耳羹、桂圆红枣汤和热甜汤；适合饭后喝点热的，也适合状态一般时补充温热甜品；口味温和。', '银耳羹和红枣汤都偏温和', '饭后或者状态一般时来一份比较舒服', '如果不想吃正餐，甜汤也能先垫一下', '热甜汤'),
(27, '北城砂锅粥馆', '北部新城', '杭行路688号', 120.152880, 30.330540, 52, 2140, 870, 47, '10:00-22:00', '主营海鲜砂锅粥、青菜粥和南瓜粥；可做清淡版本，也有适合多人分食的大份；整体适合暖胃和轻负担场景。', '砂锅粥份量足，几个人分着吃也可以', '可以做清淡版本，暖胃属性比较明显', '青菜粥和南瓜粥对轻负担需求更友好', '砂锅暖粥'),
(28, '大关小笼汤包馆', '大关', '湖州街51号', 120.145220, 30.324990, 29, 2470, 930, 46, '07:00-20:30', '主营小笼包、鲜肉汤包和热汤；适合早餐、午间快吃和想来口热汤的人；价格友好。', '小笼和热汤出餐比较快', '价格友好，工作日吃一顿没压力', '想吃点热乎的又不想花太多，这家很稳', '汤包热汤'),
(29, '上塘清补凉糖水铺', '拱宸桥/上塘', '上塘路726号', 120.141880, 30.334760, 26, 1580, 630, 45, '11:00-22:00', '主营清补凉、椰奶西米露、常温饮品和瓶装水；适合逛街休息、解腻和短时补给；也有座位可以坐一会。', '糖水和常温饮品都比较适合解腻', '有座位，逛街走累了可以坐一会', '想买水或者补充点清爽饮品时比较方便', '糖水休息'),
(30, '水晶城海鲜面馆', '水晶城', '上塘路512号', 120.157760, 30.326520, 68, 2310, 960, 46, '10:30-21:30', '主打海鲜面、蛤蜊汤面和番茄海鲜面；既有鲜味也能选清爽汤底；适合想吃热面又不想太腻的人。', '蛤蜊汤面和番茄海鲜面都比较鲜', '清爽汤底适合不想吃太腻的时候', '想吃热面但又不想太重口，这家比较合适', '海鲜热面');

DROP PROCEDURE IF EXISTS `seed_open_source_ai_food`;
DELIMITER $$
CREATE PROCEDURE `seed_open_source_ai_food`()
BEGIN
  DECLARE done INT DEFAULT 0;
  DECLARE v_seq INT;
  DECLARE v_name VARCHAR(128);
  DECLARE v_area VARCHAR(64);
  DECLARE v_address VARCHAR(255);
  DECLARE v_x DOUBLE;
  DECLARE v_y DOUBLE;
  DECLARE v_avg_price BIGINT;
  DECLARE v_sold INT;
  DECLARE v_comments INT;
  DECLARE v_score INT;
  DECLARE v_open_hours VARCHAR(64);
  DECLARE v_shop_desc VARCHAR(1024);
  DECLARE v_hint_a VARCHAR(255);
  DECLARE v_hint_b VARCHAR(255);
  DECLARE v_hint_c VARCHAR(255);
  DECLARE v_scene VARCHAR(64);
  DECLARE v_shop_id BIGINT;
  DECLARE v_blog_count INT;
  DECLARE v_blog_index INT;
  DECLARE v_author_id BIGINT;
  DECLARE v_focus VARCHAR(255);
  DECLARE v_extra VARCHAR(255);
  DECLARE v_age_days INT;

  DECLARE cur CURSOR FOR
    SELECT `seq`, `name`, `area`, `address`, `x`, `y`, `avg_price`, `sold`, `comments`, `score`, `open_hours`, `shop_desc`, `hint_a`, `hint_b`, `hint_c`, `scene`
    FROM `tmp_ai_food_shop_seed`
    ORDER BY `seq`;
  DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = 1;

  OPEN cur;
  read_loop: LOOP
    FETCH cur INTO v_seq, v_name, v_area, v_address, v_x, v_y, v_avg_price, v_sold, v_comments, v_score, v_open_hours, v_shop_desc, v_hint_a, v_hint_b, v_hint_c, v_scene;
    IF done = 1 THEN
      LEAVE read_loop;
    END IF;

    SET v_shop_id = (SELECT `id` FROM `tb_shop` WHERE `name` = v_name LIMIT 1);

    IF v_shop_id IS NULL THEN
      INSERT INTO `tb_shop` (`name`, `type_id`, `images`, `area`, `address`, `x`, `y`, `avg_price`, `sold`, `comments`, `score`, `open_hours`, `shop_desc`, `create_time`, `update_time`)
      VALUES (
        v_name,
        1,
        'https://img.meituan.net/msmerchant/054b5de0ba0b50c18a620cc37482129a45739.jpg,https://img.meituan.net/msmerchant/59b7eff9b60908d52bd4aea9ff356e6d145920.jpg,https://img.meituan.net/msmerchant/876ca8983f7395556eda9ceb064e6bc51840883.png',
        v_area,
        v_address,
        v_x,
        v_y,
      ...
      SET v_shop_id = LAST_INSERT_ID();
    ELSE
      UPDATE `tb_shop`
      SET `type_id` = 1,
          `images` = 'https://img.meituan.net/msmerchant/054b5de0ba0b50c18a620cc37482129a45739.jpg,https://img.meituan.net/msmerchant/59b7eff9b60908d52bd4aea9ff356e6d145920.jpg,https://img.meituan.net/msmerchant/876ca8983f7395556eda9ceb064e6bc51840883.png',
          `area` = v_area,
          `address` = v_address,
          `x` = v_x,
          `y` = v_y,
          ...
          `comments` = v_comments,
          `score` = v_score,
          `open_hours` = v_open_hours,
          `shop_desc` = v_shop_desc,
          `update_time` = NOW()
      WHERE `id` = v_shop_id;
    ...
    WHILE v_blog_index <= v_blog_count DO
      ...
      SET v_focus = CASE MOD(v_blog_index, 5)
        ...
        WHEN 3 THEN v_hint_c
        WHEN 4 THEN CONCAT('人均在', v_avg_price, '元左右，预算比较好控制')
        ELSE '高峰期建议提前到店或先排号'
      END;
      SET v_extra = CASE MOD(v_blog_index, 4)
        WHEN 1 THEN '服务节奏比较顺畅，点单沟通也清楚'
        WHEN 2 THEN '环境干净，适合朋友聊天或者短时休息'
        WHEN 3 THEN '如果带不同口味的朋友来，也比较容易兼顾'
        ELSE '整体出品稳定，适合回头再来'
      END;
      SET v_age_days = MOD(v_seq * 13 + v_blog_index * 7, 240);
      ...
      SET v_blog_index = v_blog_index + 1;
    END WHILE;
  END LOOP;
  CLOSE cur;
END$$
